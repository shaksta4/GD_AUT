...
/*
COMMENTED OUT THE ASSERTS IN WIDTH AND HEIGHT (Line 62 and 69). THEY WERE CAUSING PROBLEMS FOR ME.
*/
...
// COMMENTED THESE OUT BECAUSE WERE BOTH CAUSING BUGS FOR ME. 
int 
